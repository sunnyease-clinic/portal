...
export const METRIC_GROUPS: MetricGroup[] = [
  {
    ...
    metrics: [
      ...
      { key: "URR", label: "尿素清除率 URR", unit: "%", ruleKey: "urr_target", fallback: [65, null], targetHint: "> 65%" },
      { key: "eKtV", label: "透析清除率 eKt/V", unit: "", ruleKey: "ktv_target", fallback: [1.2, null], targetHint: "> 1.2" },
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: "CaP_product", label: "鈣磷乘積 Ca × P", unit: "", ruleKey: "ca_p_product_target", fallback: [null, 55], targetHint: "< 55" },
