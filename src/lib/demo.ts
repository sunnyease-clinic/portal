...
const series: Record<string, number[]> = {
  "09038C": [3.6, 3.9, 3.8, 4.0],
  URR: [63, 68, 66, 70],
  eKtV: [1.12, 1.25, 1.19, 1.3],
  "09022C": [5.6, 5.1, 5.4, 4.8],
  "09012C": [6.1, 5.2, 5.7, 5.0],
  "09011C": [8.2, 8.8, 8.5, 9.0],
  CaP_product: [50.0, 45.8, 48.5, 45.0],
  "09122C": [110, 135, 125, 140],
  "09027C": [160, 145, 152, 138],
  "08003C": [9.7, 10.3, 10.0, 10.6],
  "12116C": [900, 720, 810, 650],
  Tsat: [18, 24, 21, 28],
};
